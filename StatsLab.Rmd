...
paste("Margin of Error: ", editData.playersMarginOfError, sep="")
...
ANALYSIS TEST AREA
```{r}
# Finding the distribution of the time variable
hist(editData$time, breaks = 1000, xlim = c(0,2))
hist(rgeom(91, 1/mean(editData$time)), breaks = 30)
